...
<head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# article: http://ogp.me/ns/article#">
	...
	<meta name="description" content="サインアップエラー">
<!-- OGP -->
	...
	<meta property="og:description" content="サインアップエラー" />
    ...
    <section class="py-5 text-center container">
      ...
      <div class="row py-lg-5">
        <div class="col-lg-6 col-md-8 mx-auto mt-4">
          <h1 class="fw-light">登録エラー。</h1>
          <p class="lead text-muted"><br />
            登録に失敗した可能性があります。<br /><br />
            電話番号や郵便番号、メールアドレスを正しく入力していただく必要があります。
        </p>
          <p>
